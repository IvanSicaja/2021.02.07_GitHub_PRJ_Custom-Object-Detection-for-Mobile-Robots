...
def characterRecognition():
    ...
    while whileLoopCondition:
        try:
            ...
            # NOTE: If you want to use img for input uncomment two lines bellow
            # path = '../../developmental_phase_images/H_S_U.png'  # Wanted image
            # img = cv2.imread(path)  # Read the wanted image

            # NOTE: If you want to use video for input uncomment line bellow
            ...
            for cnt in contours:  # Individually access to every contour
                ...
                if area > 60:
                    ...
                    print("Extracted contour > than area: x,y,w,h: " + str(x) + "-" + str(y) + "-" + str(w) + "-" + str(h))
