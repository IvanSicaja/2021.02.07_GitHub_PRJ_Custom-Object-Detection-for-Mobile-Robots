...
#  TODO: EXPLORE -> WHY 1,28,28 IS DIFFERENT FROM 1,784. WHY WE NEED TO SEND 1,28,28 TO THE MODEL, AND 28,28 ALSO INST POSSIBLE?
...
if train_new_model:
    ...
    # Saving the model
    model.save('2.0_saved_trained_models/handwritten_digits__TRAINING-ACCURACY='+str(round(training_accuracy,4))+'__VALIDATION-ACCURACY='+str(round(validation_accuracy,4))+'__EPOCHS='+str(epochs)+'_'+'.h5')
    model.summary()
...
############################################### TEST TRAINED MODEL - CODE BELLOW ###############################################
    ...
    # Load the model
    model = tf.keras.models.load_model('2.0_saved_trained_models/handwritten_digits.h5')
